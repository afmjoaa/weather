        ...
        Padding(
          ...
          child: Column(
            ...
            children: const [
              ...
              Text('Demonstrating:', style: TextStyle(fontSize: 16,fontWeight: FontWeight.w900)),
              Text(
              ...
              Text('Improvement Scope:', style: TextStyle(fontSize: 16,fontWeight: FontWeight.w900)),
              Text(
